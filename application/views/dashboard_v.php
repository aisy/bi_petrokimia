                ...
                <div class="row">
                    <div class="col-md-12 pl10">
                        <div class="media mt15">
                            <a class="pull-left" href="#"> <img class="media-object thumbnail thumbnail-sm rounded" src="<?php echo base_url();?>assets/img/avatars/2.jpg" alt="..."> </a>
                            <div class="media-body">
                        ...
                        <div class="media mt15">
                            <a class="pull-left" href="#"> <img class="media-object thumbnail thumbnail-sm rounded" src="<?php echo base_url();?>assets/img/avatars/6.jpg" alt="..."> </a>
                            <div class="media-body">
                        ...
                        <div class="media mt15 mbn">
                            <a class="pull-left" href="#"> <img class="media-object thumbnail thumbnail-sm rounded" src="<?php echo base_url();?>assets/img/avatars/8.jpg" alt="..."> </a>
                            <div class="media-body">
